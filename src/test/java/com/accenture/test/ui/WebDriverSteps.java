...
/**
 ****************************************************************************
 * HIGHLIGHTS: > Methods reusable for all projects. > Methods that apply action
 * on the driver. Like navigating to a URL. > Not reference to application
 * objects. > The URL to use is project specific and can be obtained from
 * package com.projectname.data
 ****************************************************************************
 */
...
public class WebDriverSteps extends WebDriverSession {
	...
	/**
	 * OBJECTIVE: Steps to launch the driver and navigate to a url Input: name of
	 * the environment to be used. The url need to be in the
	 * com.projectname.data.Environments
	 */
	...
	public void navigateToApplication(String appName) {
		...
		// String url =
		// Environments.valueOf(SystemProperties.EXECUTION_ENVIRONMENT.toUpperCase()).getAppUrl();
		String url = this.getURL(appName);
